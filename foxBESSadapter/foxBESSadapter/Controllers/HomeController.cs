...
namespace foxBESSadatper.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        protected void polling(int asset)
        {
            ...
            String json = "{\r\n  \"sn\": \"" + chess.deviceData.deviceSN + "\",\r\n  \"variables\": [\"chargeEnergyTotal\", \"dischargeEnergyTotal\"]\r\n}";
            ...
            while (true)
            {
                ...
                try {
                    ...
                    json = "{\r\n  \"sn\": \"" + chess.deviceData.deviceSN + "\",\r\n  \"variables\": [\"chargeEnergyTotal\", \"dischargeEnergyTotal\", \"temperature\"]\r\n}";
                    response = Post(chess.location + "/op/v0/device/real/query", json, authToken);

                    realData = JsonConvert.DeserializeObject<RealDataResponse>(response);

                    foreach (RealData rd in realData.result)
                    {

                        if (rd.variable.Equals("chargeEnergyTotal"))
                            chargeTotal += rd.value;
                        if (rd.variable.Equals("dischargeEnergyTotal"))
        ...
        public IActionResult Init([Required][FromBody] CHESS body, [FromHeader] String Authorization)
        {
            ...
            String url = body.location + "/op/v0/device/list";
            String json = "{\r\n  \"currentPage\": 1,\r\n  \"pageSize\": 100\r\n}";
            String response = Post(url, json, Authorization);
