    ...
    public class Startup
    {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0", new OpenApiInfo
                    {
                        ...
                        Description = "Charging Station Monitoring API (ASP.NET Core 7.0)",
                        ...
                        TermsOfService = new Uri("https://umbrellaiot.com")
                    });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/1.0.0/swagger.json", "Charging Station Monitoring API");

                //TODO: Or alternatively use the original Swagger contract that's included in the static files
                // c.SwaggerEndpoint("/swagger-original.json", "Charging Station Monitoring API Original");
            });
